...
./run_ls.sh $FILENAME --dims $M $N --high --proj -p cw -r 300000 --nrep 40 --stack 2 -q $Q -k 1 -t --load_N --save_N --save_logs --hdfs --setting conf/settings_jiyan.cfg --logging conf/logging_exp_high.cfg
...
do
    ...
    # using sampling
    ./run_ls.sh $FILENAME --dims $M $N --high --samp -p cw -r 300000 -s $r --nrep 40 --stack 2 -q $Q -k 1 -t --load_N --save_N --save_logs --hdfs --setting conf/settings_jiyan.cfg --logging conf/logging_exp_high.cfg
done
